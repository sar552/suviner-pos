...
from suviner_pos.suviner_pos.api.utilities import (
...
def update_invoice(data):
    ...
    # locked_price endi HAMMA invoyslar uchun hurmat qilinadi (ilgari faqat
    # qaytarishlarda edi): kassir bergan qo'lda chegirma/narx qatorlari
    # set_missing_values() paytida Item Price qayta-tortilishidan himoyalanadi.
    # ESLATMA: base_discount_amount :752-762 valyuta blokida qayta
    # masshtablanmaydi — saytda invoys valyutasi == kompaniya valyutasi,
    # shuning uchun bu yerda ataylab e'tiborsiz.
    locked_items = {}
    for d in invoice_doc.items:
